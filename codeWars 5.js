...
letters of two of the words are swapped around, often with amusing results.
...
as in the above example. A "word" in the context of this kata can contain 
any of the letters A through Z in upper or lower case, and the numbers 0 to 9. 
...
function spoonerize(words) {
  ...
  let [word1, word2] = res
  let newWord1 = word1.replace(word1[0], word2[0])
  let newWord2 = word2.replace(word2[0], word1[0])
  let result = `${newWord1} ${newWord2}` 
return result
}

console.log(spoonerize('qwe asd'))
